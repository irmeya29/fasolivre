...
use App\Http\Controllers\YengaPayWebhookController;
...
Route::middleware(['auth', 'book.access'])->group(function () {
    ...
    Route::get('/listen/{slug}', [ReaderController::class, 'audio'])->name('read.audio');
});

Route::middleware('auth')->group(function () {
    Route::post('/book/{book}/progress', [BookInteractionController::class, 'updateProgress'])->name('progress.update');
    Route::get('/book/{book}/progress', [BookInteractionController::class, 'getProgress'])->name('progress.get');
    Route::post('/book/{book}/favorite', [BookInteractionController::class, 'toggleFavorite'])->name('favorite.toggle');
});
