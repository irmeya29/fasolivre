...
<div class="max-w-2xl mx-auto">
    ...
    <div class="flex items-center justify-between mb-8">
        <div class="flex items-center gap-4">
            ...
            <h1 class="text-2xl font-bold text-gray-900 tracking-tight">Modifier : {{ $category->name }}</h1>
        </div>
    </div>
        ...
        <div class="bg-white border border-gray-200 rounded-xl shadow-sm p-6 space-y-6">
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="4"
                          class="w-full rounded-lg border-gray-300 border px-4 py-2.5 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-colors">{{ old('description', $category->description) }}</textarea>
            </div>
