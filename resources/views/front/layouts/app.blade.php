            ...
            <nav class="hidden md:flex items-center gap-8 text-sm font-medium">
                ...
                <form action="{{ route('search') }}" method="GET" class="relative">
                    ...
                    <input type="text"
                           ...
                           class="pl-9 pr-3 py-2 bg-gray-100 border rounded-lg focus:bg-white focus:border-indigo-500 w-48">
                </form>
        ...
        <div class="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
                ...
                <p class="text-sm text-gray-400">
                    La plateforme africaine dédiée aux ebooks et aux auteurs.
                </p>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    <li><a href="{{ route('home') }}" class="hover:text-white flex items-center gap-1"><i data-lucide="home"></i> Accueil</a></li>
                    <li><a href="{{ route('books.index') }}" class="hover:text-white flex items-center gap-1"><i data-lucide="library"></i> Livres</a></li>
                    <li><a href="{{ route('authors.index.front') }}" class="hover:text-white flex items-center gap-1"><i data-lucide="users"></i> Auteurs</a></li>
                    <li><a href="{{ route('categories.index.front') }}" class="hover:text-white flex items-center gap-1"><i data-lucide="grid"></i> Catégories</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    @auth
                        <li><a href="{{ route('account.index') }}" class="hover:text-white flex items-center gap-1"><i data-lucide="user"></i> Mon compte</a></li>
                        <li>
                            <form action="{{ route('logout') }}" method="POST">@csrf
                                <button class="hover:text-white flex items-center gap-1"><i data-lucide="log-out"></i> Déconnexion</button>
                            </form>
                        </li>
                    @else
                        <li><a href="{{ route('login') }}" class="hover:text-white flex items-center gap-1"><i data-lucide="log-in"></i> Connexion</a></li>
                        <li><a href="{{ route('register') }}" class="hover:text-white flex items-center gap
							1"><i data-lucide="user-plus"></i> Inscription</a></li>
                    @endauth
                </ul>
            </div>
